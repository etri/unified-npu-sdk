...
- `llm` flavor 이미지는 release container 위에 matching TensorRT-LLM source checkout(`r26.05` 기본)을 함께 포함합니다. checkpoint prepare wrapper 는 installed API 를 우선 쓰고, 필요하면 이 bundled source 를 fallback 으로 사용합니다.
